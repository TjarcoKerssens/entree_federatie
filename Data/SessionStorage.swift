...
class SessionStorage{
    ...
    init() {
        guard let accessGroup = Bundle.main.infoDictionary?["AccesGroup"] as? String else {return}
        keychain.accessGroup =  accessGroup // Allows the session to be shared amongst applications
